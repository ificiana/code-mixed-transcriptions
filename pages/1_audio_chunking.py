...
st.set_page_config(page_title="Audio Chunking", page_icon="✂️", layout="wide")
    ...
    if os.path.exists("temp_chunks"):
        ...
        for file in os.listdir("temp_chunks"):
            try:
                ...
                logger.warning(
                    f"Failed to remove chunk file {file}: {str(e)}", exc_info=True
                )
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            if (
                ...
                or st.session_state.chunk_paths is None
            ):
            ...
            try:
                ...
                logger.warning(
                    f"Failed to clean up temporary file: {tmp_filepath}", exc_info=True
                )
